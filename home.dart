  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        useMaterial3: true,
        fontFamily: 'Roboto',
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 226, 223, 229)),
      ),
...
class _SosButton extends StatelessWidget {
  ...
  Future<void> _triggerSOS(BuildContext context) async {
    try {
      ...
      // 4️⃣ Show nice SOS popup (demo mode for Chrome)
      await showDialog(
        context: context,
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                "🚨 SOS Alert! I need help. My location: $googleMapsLink",
